...
const Community = () => {
    ...
    const likePost = async (postId) => {
        try {
            ...
            const response = await fetch(`${server_url}post/${postId}/like`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    return (
        ...
        //     </div>
        // </div>
        <div className='h-screen flex items-center justify-center underline font-bold text-xl'>Comming Soon ...</div>
    );
}
