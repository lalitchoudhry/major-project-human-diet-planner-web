...
const llm = new OpenAI({
  apiKey: "27b95a3400e500cba3ab6afb030a0dae16b8d45fcb4626456aa5acc5b7901018",
...
const MealPlan = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-beige-100 to-beige-300 relative">
      ...
      <div className="max-w-4xl w-full mx-auto flex flex-col mt-20 relative z-10">
        {/* Form Section */}
        <div className="md:w-1/2 p-4">
          <label htmlFor="dietary" className="mb-1 block text-xl text-gray-800">
            Required Calories
          </label>
          <input
            className="mb-2 p-2 border rounded-md w-full"
            type="text"
            placeholder="Please Enter Required Calories Needed..."
          ...
          <button
            className="mb-4 px-4 py-2 bg-white text-accent text-xl font-bold rounded-md shadow-md hover:bg-accent hover:text-white"
            onClick={getMealPlan}
          >
            Generate Meal Plan
          </button>
            ...
            <div key={index} className="py-4 bg-lime-90 rounded-lg px-4 mb-4">
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: meal.description.replace(/\n/g, "<br>"),
                }}
              ></p>
            </div>
          ))}
